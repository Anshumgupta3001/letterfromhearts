...
const MOOD_META = {
  vent:      { emoji: '🌧️', label: 'I need to vent',  bg: 'rgba(59,54,99,0.12)',      color: 'var(--ink-soft)'  },
  joy:       { emoji: '🌟', label: 'Pure joy',         bg: 'rgba(224,107,40,0.15)',    color: 'var(--gold)'      },
  love:      { emoji: '💌', label: 'Love & warmth',    bg: 'rgba(244,129,63,0.12)',     color: 'var(--tc)'        },
  grief:     { emoji: '🕯️', label: 'Grief & loss',    bg: 'rgba(46,125,91,0.14)',   color: 'var(--sage)'      },
  gratitude: { emoji: '🌿', label: 'Gratitude',        bg: 'rgba(122,112,92,0.12)',    color: '#5A5580'          },
  longing:   { emoji: '🌙', label: 'Longing',          bg: 'rgba(92,79,168,0.14)',   color: 'var(--purple)'   },
}

const TYPE_META = {
  personal: { label: 'Personal',        color: 'var(--tc)',     bg: 'rgba(244,129,63,0.08)',   border: 'rgba(244,129,63,0.2)'   },
  stranger: { label: 'Caring Stranger', color: 'var(--sage)',   bg: 'rgba(46,125,91,0.08)', border: 'rgba(46,125,91,0.2)' },
  sent:     { label: 'Sent Letter',     color: 'var(--gold)',   bg: 'rgba(224,107,40,0.08)',  border: 'rgba(224,107,40,0.2)'  },
  received: { label: 'Received Letter', color: 'var(--purple)', bg: 'rgba(92,79,168,0.08)', border: 'rgba(92,79,168,0.2)' },
}
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
      {Array.from({ length: max }).map((_, i) => (
        <div key={i} style={{
          ...
          height: i < count ? 7 : 5,
          borderRadius: '50%',
          background: i < count ? 'var(--tc)' : 'rgba(59,54,99,0.12)',
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        boxShadow: isMine
          ? '0 4px 16px rgba(244,129,63,0.22)'
          : '0 2px 10px rgba(59,54,99,0.08)',
        border: isMine ? 'none' : '1px solid rgba(59,54,99,0.07)',
        letterSpacing: '0.01em',
      }}>
        {msg.content}
      </div>
      <div style={{
        fontSize: 10, color: 'var(--ink-muted)', fontFamily: '"Inter", system-ui, sans-serif',
  ...
  return (
    <>
      ...
      >
        ...
        <div style={{
          padding: '16px 24px',
          borderBottom: '1px solid rgba(59,54,99,0.07)',
          ...
          <button
            ...
            style={{
              ...
              background: 'rgba(59,54,99,0.06)', border: 'none',
              cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: 16, color: 'var(--ink-muted)', flexShrink: 0,
              transition: 'background 0.2s, color 0.2s',
            }}
            onMouseEnter={e => { e.currentTarget.style.background = 'rgba(59,54,99,0.12)'; e.currentTarget.style.color = 'var(--ink)' }}
            onMouseLeave={e => { e.currentTarget.style.background = 'rgba(59,54,99,0.06)'; e.currentTarget.style.color = 'var(--ink-muted)' }}
          >✕</button>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            background: 'rgba(244,129,63,0.94)', color: '#fff', borderRadius: 10,
            padding: '11px 18px', display: 'flex', alignItems: 'flex-start', gap: 10,
            boxShadow: '0 4px 20px rgba(244,129,63,0.28)',
            ...
            <div>
              <div style={{ fontFamily: '"Inter", system-ui, sans-serif', fontSize: 13, fontWeight: 600, lineHeight: 1.4 }}>Sent</div>
              <div style={{ fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', fontSize: 12, opacity: 0.88, marginTop: 2 }}>
          ...
          <div style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', padding: '0 20px 32px' }}>
            <div style={{ maxWidth: 520, margin: '0 auto' }}>
              ...
              <div style={{
                ...
                boxShadow: '0 8px 32px rgba(59,54,99,0.08), 0 2px 8px rgba(59,54,99,0.04)',
                border: '1px solid rgba(59,54,99,0.08)', borderTop: 'none',
                ...
                <div style={{ fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', fontSize: 12, color: 'var(--ink-muted)', textAlign: 'right', marginBottom: 28 }}>{date}</div>
                <h2 style={{ fontFamily: '"Inter", system-ui, sans-serif', fontSize: 'clamp(22px, 3vw, 30px)', fontWeight: 700, color: 'var(--ink)', lineHeight: 1.2, letterSpacing: '-0.4px', marginBottom: 6, wordBreak: 'break-word', overflowWrap: 'break-word' }}>
                ...
                {letter.type === 'sent' && letter.toEmail && (
                  <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
                    <span style={{ fontSize: 11, color: 'var(--ink-muted)', fontFamily: '"Inter", system-ui, sans-serif' }}>With:</span>
                    <span style={{ fontSize: 11.5, color: 'var(--ink-soft)', fontFamily: '"Inter", system-ui, sans-serif', fontWeight: 500, wordBreak: 'break-all' }}>
                      {letter.toEmail}
                    </span>
                  </div>
                )}
                ...
                <div style={{ height: 1, background: 'linear-gradient(90deg, rgba(59,54,99,0.12), transparent)', margin: '20px 0 28px' }} />
                <div style={{ fontFamily: '"Inter", system-ui, sans-serif', fontSize: 'clamp(14px, 1.8vw, 15.5px)', lineHeight: 2.05, color: 'var(--ink-soft)', whiteSpace: 'pre-line', wordBreak: 'break-word', overflowWrap: 'break-word', maxWidth: '100%' }}>
                  {letter.message || '(No content)'}
                </div>
                <div style={{ marginTop: 48, paddingTop: 24, borderTop: '1px solid rgba(59,54,99,0.07)', textAlign: 'center' }}>
                  <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '9px 20px', borderRadius: 40, background: 'rgba(59,54,99,0.03)', border: '1px solid rgba(59,54,99,0.08)' }}>
                    <span style={{ fontSize: 14, opacity: 0.5 }}>✉</span>
                    <span style={{ fontSize: 10, letterSpacing: '2px', textTransform: 'uppercase', color: 'var(--ink-muted)', fontFamily: '"Inter", system-ui, sans-serif' }}>Letter from Heart</span>
                  </div>
                </div>
              </div>
              ...
              {(isListenerView || isKnownRecipient) && (
                <div style={{ marginTop: 24 }}>
                  {convLoading ? (
                    <div style={{ textAlign: 'center', padding: '32px 0', fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', fontSize: 13, color: 'var(--ink-muted)' }}>
                      Loading…
                    </div>
                  ) : (
                    <div style={{
                      ...
                      background: '#FFFFFF',
                      border: isEnded
                        ? '1px solid rgba(59,54,99,0.1)'
                        : '1px solid rgba(244,129,63,0.14)',
                      boxShadow: '0 4px 24px rgba(59,54,99,0.06)',
                      overflow: 'hidden',
                    }}>
                      ...
                      <div style={{
                        ...
                        background: isEnded
                          ? 'rgba(59,54,99,0.03)'
                          : 'linear-gradient(135deg, rgba(244,129,63,0.06) 0%, rgba(224,107,40,0.04) 100%)',
                        borderBottom: '1px solid rgba(59,54,99,0.07)',
                      }}>
                        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 8 }}>
                          <div>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 3 }}>
                              ...
                              <span style={{ fontFamily: '"Inter", system-ui, sans-serif', fontSize: 13, fontWeight: 600, color: isEnded ? 'var(--ink-muted)' : (isKnownRecipient ? 'var(--purple)' : 'var(--tc)'), letterSpacing: '-0.1px' }}>
                                {isEnded ? 'Conversation closed' : (isKnownRecipient ? 'Reply to this letter' : 'A quiet conversation')}
                              </span>
                            </div>
                            <div style={{ fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', fontSize: 12, color: 'var(--ink-muted)', paddingLeft: 22, lineHeight: 1.5 }}>
                              {isEnded
                          ...
                          {!isEnded && (
                            <div style={{ flexShrink: 0, paddingTop: 2 }}>
                              ...
                              <div style={{ fontSize: 9, color: 'var(--ink-muted)', fontFamily: '"Inter", system-ui, sans-serif', textAlign: 'right', marginTop: 4 }}>
                      ...
                      <div style={{
                        ...
                        {messages.length === 0 && !isEnded && (
                          <div style={{ textAlign: 'center', padding: '20px 0', fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', fontSize: 13, color: 'var(--ink-muted)', lineHeight: 1.7 }}>
                        ...
                        {messages.map((msg, i) => {
                          ...
                          return (
                            <div key={msg._id || i}>
                              {showDate && (
                                <div style={{ textAlign: 'center', margin: '4px 0 12px', fontSize: 10, color: 'var(--ink-muted)', fontFamily: '"Inter", system-ui, sans-serif', letterSpacing: '0.8px', textTransform: 'uppercase' }}>
                      ...
                      {(isEnded || limitReached) && (
                        <div style={{
                          padding: '16px 18px',
                          background: 'rgba(59,54,99,0.025)',
                          borderTop: '1px solid rgba(59,54,99,0.07)',
                          textAlign: 'center',
                        }}>
                          <div style={{ fontSize: 18, marginBottom: 6 }}>
                            {isEnded ? '🕯️' : '💌'}
                          </div>
                          <div style={{ fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', fontSize: 13, color: 'var(--ink-soft)', lineHeight: 1.65 }}>
                            {isEnded
                              ? <>
                          ...
                          <div style={{ fontFamily: '"Inter", system-ui, sans-serif', fontSize: 11, color: 'var(--ink-muted)', marginTop: 5 }}>
                            {isEnded
                      ...
                      {confirmEnd && !isEnded && (
                        <div style={{
                          ...
                          <div style={{ fontFamily: '"Inter", system-ui, sans-serif', fontSize: 13, fontWeight: 600, color: '#E06B28', marginBottom: 6 }}>
                            Close this conversation?
                          </div>
                          <div style={{ fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', fontSize: 12.5, color: 'var(--ink-muted)', lineHeight: 1.65, marginBottom: 14 }}>
                          ...
                          <div style={{ display: 'flex', gap: 8 }}>
                            <button
                              ...
                              style={{
                                ...
                                background: 'transparent', border: '1px solid rgba(59,54,99,0.15)',
                                color: 'var(--ink-muted)', cursor: 'pointer',
                                fontSize: 12.5, fontFamily: '"Inter", system-ui, sans-serif', fontWeight: 500,
                                transition: 'background 0.15s',
                              }}
                              onMouseEnter={e => e.currentTarget.style.background = 'rgba(59,54,99,0.04)'}
                            ...
                            <button
                              ...
                              style={{
                                flex: 1, padding: '9px 0', borderRadius: 9,
                                background: ending ? 'rgba(180,60,60,0.4)' : '#E06B28',
                                color: '#fff', border: 'none', cursor: ending ? 'default' : 'pointer',
                                fontSize: 12.5, fontFamily: '"Inter", system-ui, sans-serif', fontWeight: 600,
                        ...
                        <div style={{
                          ...
                          {messages.length > 0 && (
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingLeft: 2 }}>
                              <span style={{ fontSize: 11, fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', color: 'var(--ink-muted)', opacity: 0.8 }}>
                              ...
                              <button
                                ...
                                onMouseEnter={e => e.currentTarget.style.color = '#E06B28'}
                          ...
                          {sendError && (
                            <div style={{ fontSize: 12, color: 'var(--tc)', fontFamily: '"Inter", system-ui, sans-serif', padding: '7px 11px', background: 'rgba(244,129,63,0.06)', borderRadius: 8, border: '0.5px solid rgba(244,129,63,0.2)' }}>
                              {sendError}
                            </div>
                          )}
                          ...
                          <textarea
                            ...
                            style={{
                              ...
                              fontSize: 14, fontFamily: '"Inter", system-ui, sans-serif', color: 'var(--ink)',
                              outline: 'none', resize: 'none', boxSizing: 'border-box',
                              lineHeight: 1.75, transition: 'border-color 0.2s, box-shadow 0.2s',
                            }}
                            onFocus={e => { e.target.style.borderColor = 'rgba(244,129,63,0.5)'; e.target.style.boxShadow = '0 0 0 3px rgba(244,129,63,0.07)' }}
                            onBlur={e => { e.target.style.borderColor = 'rgba(244,129,63,0.2)'; e.target.style.boxShadow = 'none' }}
                          />

                          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <span style={{ fontSize: 11, fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', color: 'var(--sage)', opacity: 0.85 }}>
                              Speak gently 💛
                            </span>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                              ...
                              <button
                                ...
                                style={{
                                  ...
                                  background: sending || !text.trim() ? 'rgba(244,129,63,0.3)' : 'var(--tc)',
                                  color: '#fff', border: 'none',
                                  cursor: sending || !text.trim() ? 'default' : 'pointer',
                                  fontSize: 13, fontFamily: '"Inter", system-ui, sans-serif', fontWeight: 500,
                                  display: 'flex', alignItems: 'center', gap: 7,
                                  boxShadow: sending || !text.trim() ? 'none' : '0 4px 14px rgba(244,129,63,0.3)',
                                  transition: 'background 0.15s, transform 0.15s, box-shadow 0.15s',
                                }}
                                onMouseEnter={e => { if (!sending && text.trim()) { e.currentTarget.style.transform = 'translateY(-1px)'; e.currentTarget.style.boxShadow = '0 6px 18px rgba(244,129,63,0.38)' } }}
                                onMouseLeave={e => { e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = sending || !text.trim() ? 'none' : '0 4px 14px rgba(244,129,63,0.3)' }}
                              >
              ...
              {(isSeekerView || isKnownSender) && (
                <div style={{ marginTop: 24 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                    <div style={{ flex: 1, height: 1, background: 'rgba(59,54,99,0.08)' }} />
                    <span style={{ fontSize: 10, letterSpacing: '1.8px', textTransform: 'uppercase', color: 'var(--ink-muted)', fontFamily: '"Inter", system-ui, sans-serif', flexShrink: 0 }}>
                      {isKnownSender
                  ...
                  {seekerConvsLoading ? (
                    ...
                    <div style={{ padding: '28px 20px', borderRadius: 14, textAlign: 'center', background: 'rgba(59,54,99,0.025)', border: '1px dashed rgba(59,54,99,0.1)' }}>
                      <div style={{ fontSize: 24, marginBottom: 10, opacity: 0.4 }}>{isKnownSender ? '📬' : '🌿'}</div>
                      <div style={{ fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', fontSize: 13.5, color: 'var(--ink-muted)', lineHeight: 1.7 }}>
                        {isKnownSender
                        ...
                        return (
                          <div
                            ...
                            style={{
                              ...
                              border: cEnded
                                ? '1px solid rgba(59,54,99,0.1)'
                                : '1px solid rgba(46,125,91,0.2)',
                              boxShadow: '0 4px 20px rgba(59,54,99,0.05)',
                              overflow: 'hidden',
                            }}
                          >
                            {/* Card header */}
                            <div style={{
                              ...
                              background: cEnded
                                ? 'rgba(59,54,99,0.03)'
                                : 'linear-gradient(135deg, rgba(46,125,91,0.07) 0%, rgba(224,107,40,0.04) 100%)',
                              borderBottom: '1px solid rgba(59,54,99,0.07)',
                              ...
                              <div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 3 }}>
                                  ...
                                  <span style={{ fontFamily: '"Inter", system-ui, sans-serif', fontSize: 12.5, fontWeight: 600, color: cEnded ? 'var(--ink-muted)' : (isKnownSender ? 'var(--purple)' : 'var(--sage)') }}>
                                    {isKnownSender ? 'Their reply' : `Listener ${ci + 1}`}
                                  </span>
                                </div>
                                <div style={{ fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', fontSize: 11.5, color: 'var(--ink-muted)', paddingLeft: 21 }}>
                                  {cEnded
                                    ? <>
                                        Closed with care
                              ...
                              {!cEnded && (
                                <div style={{ flexShrink: 0, paddingTop: 2, textAlign: 'right' }}>
                                  ...
                                  <div style={{ fontSize: 9, color: 'var(--ink-muted)', fontFamily: '"Inter", system-ui, sans-serif', marginTop: 4 }}>
                            ...
                            <div style={{ padding: '16px 14px 10px', display: 'flex', flexDirection: 'column', gap: 12, background: 'rgba(248,244,238,0.5)' }}>
                              {cMessages.map((msg, i) => {
                                ...
                                return (
                                  <div key={msg._id || i}>
                                    {showDate && (
                                      <div style={{ textAlign: 'center', margin: '4px 0 10px', fontSize: 10, color: 'var(--ink-muted)', fontFamily: '"Inter", system-ui, sans-serif', letterSpacing: '0.8px', textTransform: 'uppercase' }}>
                                        {formatDate(msg.createdAt)}
                                      </div>
                                    )}
                                    <Bubble msg={msg} isMine={isMine} />
                            ...
                            {(cEnded || cLimitReached) && (
                              <div style={{ padding: '14px 18px', background: 'rgba(59,54,99,0.025)', borderTop: '1px solid rgba(59,54,99,0.07)', textAlign: 'center' }}>
                                <div style={{ fontSize: 16, marginBottom: 5 }}>{cEnded ? '🕯️' : '💌'}</div>
                                <div style={{ fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', fontSize: 12.5, color: 'var(--ink-muted)', lineHeight: 1.6 }}>
                                  {cEnded
                                    ? <>
                              ...
                              <div style={{
                                ...
                                <div style={{ display: 'flex', gap: 8 }}>
                                  ...
                                  <button
                                    ...
                                    style={{
                                      flex: 1, padding: '9px 0', borderRadius: 9,
                                      background: seekerEnding ? 'rgba(180,60,60,0.4)' : '#E06B28',
                            ...
                            {cCanSend && seekerConfirmEnd !== c._id && (
                              <div style={{ padding: '12px 14px 14px', borderTop: '1px solid rgba(59,54,99,0.07)', background: '#fff', display: 'flex', flexDirection: 'column', gap: 10 }}>
                                {/* Close affordance */}
                                {cMessages.length > 0 && (
                                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingLeft: 2 }}>
                                    <span style={{ fontSize: 11, fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', color: 'var(--ink-muted)', opacity: 0.8 }}>
                                ...
                                {seekerError && (
                                  <div style={{ fontSize: 12, color: 'var(--tc)', fontFamily: '"Inter", system-ui, sans-serif', padding: '6px 10px', background: 'rgba(244,129,63,0.06)', borderRadius: 8 }}>
                                    {seekerError}
                                  </div>
                                )}
                                <textarea
                                  ...
                                  onFocus={e => { e.target.style.borderColor = 'rgba(46,125,91,0.5)'; e.target.style.boxShadow = '0 0 0 3px rgba(46,125,91,0.07)' }}
                                  onBlur={e => { e.target.style.borderColor = 'rgba(46,125,91,0.22)'; e.target.style.boxShadow = 'none' }}
                                />
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                  <span style={{ fontSize: 11, fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', color: 'var(--sage)', opacity: 0.85 }}>
                                    Speak gently 💛
                                  ...
                                  <button
                                    ...
                                    style={{
                                      ...
                                      background: seekerSending || !seekerText.trim() ? 'rgba(46,125,91,0.3)' : 'var(--sage)',
                                      color: '#fff', border: 'none',
                                      cursor: seekerSending || !seekerText.trim() ? 'default' : 'pointer',
                                      fontSize: 12.5, fontFamily: '"Inter", system-ui, sans-serif', fontWeight: 500,
                                      display: 'flex', alignItems: 'center', gap: 6,
                                      boxShadow: seekerSending || !seekerText.trim() ? 'none' : '0 4px 12px rgba(46,125,91,0.28)',
                                      transition: 'background 0.15s, transform 0.15s, box-shadow 0.15s',
                                    }}
                                    onMouseEnter={e => { if (!seekerSending && seekerText.trim()) { e.currentTarget.style.transform = 'translateY(-1px)'; e.currentTarget.style.boxShadow = '0 6px 16px rgba(46,125,91,0.35)' } }}
                                    onMouseLeave={e => { e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = seekerSending || !seekerText.trim() ? 'none' : '0 4px 12px rgba(46,125,91,0.28)' }}
                                  >
        ...
        {!letter && (
          <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--ink-muted)', fontFamily: '"Inter", system-ui, sans-serif', fontStyle: 'italic', fontSize: 14 }}>
